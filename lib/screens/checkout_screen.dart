...
class _CheckoutScreenState extends State<CheckoutScreen> {
  ...
  final List<String> _pickupTimes = ["12:00 PM", "12:15 PM", "12:30 PM", "12:45 PM"];
  ...
  Future<void> _processPayment(BuildContext context) async {
    ...
    if (_walletBalance < cart.totalAmount) {
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(content: Text("Insufficient funds! Please top up your wallet.")),
      );
      return;
    }
    ...
    try {
      ...
      final orderData = {
        ...
        // Giả lập pickup time: cộng thêm 30 phút từ bây giờ
        "pickupTime": DateTime.now().add(const Duration(minutes: 30)).toIso8601String() 
      };
  ...
  Future<void> _confirmPayment(int orderId) async {
    ...
    final response = await http.post(
      Uri.parse('${ApiConfig.baseUrl}/api/orders/$orderId/confirm-payment'),
    ...
    if (response.statusCode == 200) {
      ...
      showDialog(
        ...
        builder: (ctx) => AlertDialog(
          ...
          content: const Text("Your order has been placed and paid successfully."),
          actions: [
            TextButton(
              onPressed: () {
                ...
                children: [
                  ...
                  Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        Row(
                          children: [
                            Container(
                              ...
                              decoration: BoxDecoration(color: brandGreen.withOpacity(0.1), borderRadius: BorderRadius.circular(10)),
                              child: const Icon(Icons.account_balance_wallet, color: brandGreen),
                            ),
                        ...
                        Text("\$${_walletBalance.toStringAsFixed(2)}", style: const TextStyle(fontSize: 32, fontWeight: FontWeight.bold)),
                        const SizedBox(height: 5),
                        Row(
                          children: [
                            Icon(isSufficient ? Icons.check_circle : Icons.error, 
                                 color: isSufficient ? brandGreen : Colors.red, size: 16),
                            const SizedBox(width: 5),
                            Text(
                              isSufficient ? "SUFFICIENT FUNDS" : "INSUFFICIENT FUNDS",
                              style: TextStyle(color: isSufficient ? brandGreen : Colors.red, fontWeight: FontWeight.bold, fontSize: 12),
                            )
                          ],
                        )
                      ],
                    ...
                    child: ListView.separated(
                      ...
                      itemBuilder: (ctx, i) {
                        ...
                        return ListTile(
                          ...
                          subtitle: Text(item.selectedOptions.join(", "), maxLines: 1, overflow: TextOverflow.ellipsis),
                  ...
                  SizedBox(
                    ...
                    child: ElevatedButton(
                      onPressed: isSufficient ? () => _processPayment(context) : null,
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          const SizedBox(width: 10),
                          Text("Pay \$${cart.totalAmount.toStringAsFixed(2)}", 
